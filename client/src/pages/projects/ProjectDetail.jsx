    ...
    <div className="p-6 sm:p-8 max-w-7xl mx-auto">
      ...
      {proj && (
        <div className="card p-4 mb-6 flex items-center gap-6">
          <div className="flex-1"><div className="flex justify-between text-sm mb-1.5"><span className="font-medium text-gray-700 dark:text-gray-300">Overall Progress</span><span className="font-bold text-blue-600">{proj.progress??0}%</span></div><ProgressBar value={proj.progress??0}/></div>
