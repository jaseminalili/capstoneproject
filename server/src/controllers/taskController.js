...
exports.getOne = async (req, res, next) => {
  try {
    ...
    const [comments, activities, project] = await Promise.all([
      query(
        `SELECT tc.*,u.name user_name,u.avatar user_avatar,u.color user_color
...
exports.addComment = async (req, res, next) => {
  ...
  try {
    ...
    const full = (await query(
      `SELECT tc.*,u.name user_name,u.email user_email,u.avatar user_avatar,u.color user_color
